...
exports.POSE_HTML_BUILD = '20260921-offlineBlazeposeCdn';
...
function buildPoseHtml(parts, options) {
    ...
    const config = JSON.stringify({
        ...
        inferFrameSkip: isAndroid
            ? (isBlazePose ? captureMode_1.ANDROID_INFER_FRAME_SKIP_BLAZEPOSE : captureMode_1.ANDROID_INFER_FRAME_SKIP)
            : 0,
