...
export type AndroidSoftCapProfile =
  | 'prime'
  | 'pro'
  | 'lite'
  | 'ultralite'
 ...
 */
export const CAPTURE_CONSTRAINT_MODE: CaptureConstraintMode = 'device-native';
 ...
 */
export const ENABLE_MALI_HARD_CAP = false;
 ...
 * - `2` — every 3rd, etc.
 */
export const ANDROID_INFER_FRAME_SKIP = 1;
 ...
 */
export const ANDROID_INFER_FRAME_SKIP_BLAZEPOSE = 2;

/**
 * Android-only preprocess path. iOS always uses `imagebitmap` (unchanged).
 */
export const ANDROID_PREPROCESS_PATH: AndroidPreprocessPath = 'canvas-direct';
 ...
 */
export const ANDROID_SOFT_CAP_PROFILE: AndroidSoftCapProfile | null = 'basic';
 ...
 */
export const ANDROID_MIN_TARGET_FPS = 10;
 ...
 */
export const ANDROID_PERF_DEBUG = true;
