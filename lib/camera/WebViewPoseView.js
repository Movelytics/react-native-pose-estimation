...
function WebViewPoseView(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: [styles.fill, props.style], collapsable: false, children: [(0, jsx_runtime_1.jsx)(WebView, { ref: webRef, style: react_native_1.StyleSheet.absoluteFill, originWhitelist: ['*'], source: { html, baseUrl: 'https://localhost/' }, mixedContentMode: "always", allowFileAccess: true, mediaPlaybackRequiresUserAction: false, mediaCapturePermissionGrantType: "grant", allowsInlineMediaPlayback: true, javaScriptEnabled: true, domStorageEnabled: true, 
